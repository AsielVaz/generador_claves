<x-layouts.app title="Pagar con efectivo" heading="Pagar con efectivo">
    <style>
        .cash-payment-layout {
            display: grid;
    ...
    <div class="cash-payment-layout" style="display: grid; gap: 24px; align-items: start;">
        ...
        <section class="rounded-lg border border-white/70 bg-white/75 p-5 shadow-sm backdrop-blur" style="border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.7); background: rgba(255, 255, 255, 0.75); padding: 20px; box-shadow: 0 18px 45px rgba(15, 23, 42, 0.08); backdrop-filter: blur(18px);">
            <form method="POST" action="{{ route('payments.cash.store') }}" class="grid gap-4" style="display: grid; gap: 16px;">
                @csrf
                ...
                <div class="cash-payment-fields" style="display: grid; gap: 16px;">
                    <div class="cash-payment-span sm:col-span-2" style="grid-column: 1 / -1;">
                ...
                <button class="rounded-md bg-emerald-700 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-emerald-800" style="width: 100%; border: 0; border-radius: 6px; background: linear-gradient(135deg, #1f2937, #0f766e); padding: 10px 16px; font-size: 14px; font-weight: 700; color: #ffffff; box-shadow: 0 16px 32px rgba(15, 118, 110, 0.22); cursor: pointer;">Continuar con pago en efectivo</button>
            </form>
        </section>
    </div>
</x-layouts.app>
