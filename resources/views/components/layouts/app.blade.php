                ...
                <div class="flex h-full flex-col px-5 py-5">
                    ...
                    <nav class="mt-6 flex gap-2 overflow-x-auto lg:flex-col lg:overflow-visible">
                        ...
                        @if (! auth()->user()->is_admin)
                            ...
                            <a href="{{ route('payments.index') }}" class="rounded-md px-3 py-2 text-sm font-medium {{ request()->routeIs('payments.index', 'payments.create', 'payments.preview', 'payments.store') ? 'bg-zinc-950 text-white' : 'text-zinc-600 hover:bg-zinc-100 hover:text-zinc-950' }}">Pagos</a>
                            <a href="{{ route('payments.card.create') }}" class="rounded-md px-3 py-2 text-sm font-medium {{ request()->routeIs('payments.card.*') ? 'bg-zinc-950 text-white' : 'text-zinc-600 hover:bg-zinc-100 hover:text-zinc-950' }}">Pago con PayPal</a>
                            <a href="{{ route('payments.cash.create') }}" class="rounded-md px-3 py-2 text-sm font-medium {{ request()->routeIs('payments.cash.*') ? 'bg-zinc-950 text-white' : 'text-zinc-600 hover:bg-zinc-100 hover:text-zinc-950' }}">Pagar con efectivo</a>
                        @else
